...
import { addDocumentSchema, createPropertySchema, updatePropertySchema, } from "../validators/property.validator.js";
const router = Router();
/**
 ...
 */
const notMe = (req, _res, next) => next(req.params.slug === "me" ? "route" : undefined);
