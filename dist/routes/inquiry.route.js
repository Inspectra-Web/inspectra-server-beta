...
import { addInquiryMessage, createInquiry, getLead, getMyInquiry, listLeads, listMyInquiries, updateLeadStatus, } from "../controllers/inquiry.controller.js";
import AppError from "../error/app.error.js";
import { protect, restrictTo } from "../middlewares/auth.middleware.js";
import validate from "../middlewares/validate.middleware.js";
import { addMessageSchema, createInquirySchema, inquiryStatusSchema, } from "../validators/inquiry.validator.js";
const tooManyInquiries = (_req, _res, next) => next(new AppError("Too many inquiries. Please try again later.", 429));
...
router.post("/", restrictTo("seeker"), inquiryLimiter, validate(createInquirySchema), createInquiry);
...
router.patch("/leads/:id/status", restrictTo("realtor"), validate(inquiryStatusSchema), updateLeadStatus);
