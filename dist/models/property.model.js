...
export const DOCUMENT_STATUSES = ["pending", "verified", "flagged"];
 ...
 */
export const buildSlug = (title, id) => {
    const base = title
        .toLowerCase()
        .normalize("NFKD")
...
propertySchema.pre("validate", function () {
    ...
    if (!this.slug && this.title)
        this.slug = buildSlug(this.title, String(this._id));
});
/**
 ...
 */
export const listingCard = (property) => ({
    id: property._id,
    slug: property.slug,
 ...
 */
export const detailedProperty = (property) => ({
    id: property._id,
    ref: property.ref,
    slug: property.slug,
    title: property.title,
...
export const publicProperty = (property) => ({
    id: property._id,
    ref: property.ref,
    slug: property.slug,
